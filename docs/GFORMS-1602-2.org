...
Date: Thu, 31 Mar 2022 13:23:09 GMT
Content-Type: application/json
Content-Length: 459

{
  "error": "List((/sections(3)/summaryDescription,List(JsonValidationError(List(error.path.missing),WrappedArray()))), (/sections(3)/addAnotherQuestion,List(JsonValidationError(List(UnexpectedState(Unsupported combination of 'format, choices, multivalue and value':\nFormat     : None\nChoices    : None\nMultivalue : None\nValue      : None\noptionHints: None\noptionHelpText: None\n)),WrappedArray()))))",
  "occurrenceId": "921461d7-60d4-4b21-af08-b8a8198f66f4"
}
#+end_src
